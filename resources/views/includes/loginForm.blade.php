<div>
      ...
      <form action="{{ route('login.auth') }}" method="POST">
        ...
        <br>
        <div>
          <a href="{{ route('login.facebook') }}" role="button" style="background-color:blue; color:white; padding:7px; text-decoration:none">Or Login with Facebook</a>
        </div>
        <br>
        <div>
          <a href="{{ route('google-auth') }}" role="button" style="background-color:red; color:white; padding:7px; text-decoration:none">Or Login with Google</a>
        </div>
</div>